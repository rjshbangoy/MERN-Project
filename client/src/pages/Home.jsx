      ...
      {/* top */}
        <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
          <h1 className='text-slate-700 font-bold text-3xl lg:text-6xl'>
            Real Estate, <span className='text-slate-500'>Real Easy.</span>
            <br />
            Seamless living starts here.
          </h1>
          <div className='text-slate-700'>
            Navigate the world of real estate effortlessly with ArdrichEstate.
            <br />
            Explore, Envision, Experience your next home.
          </div>
